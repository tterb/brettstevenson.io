...
const About = ({ id, avatar, isMobile }) => (
  <Divider
    className='flex relative w-full h-full max-h-300 md:max-h-240'
    bg='#23262b'
    clipPath='polygon(0 12%, 100% 0%, 100% 88%, 0 100%)'
  >
    <Content id={id} className='pt-20 pb-20'>
      <Inner style={{ marginTop: '12%' }}>
        ...
        <div className='flex flex-col md:flex-row items-center mt-0 md:pt-2 px-2'>
          <GatsbyImage
            className='rounded-full w-auto h-auto max-w-50vw xs:w-1/2 xs:hidden sm:block md:max-w-160 xl:max-w-200'
            image={avatar}
            alt='Brett Stevenson'
            style={avatarStyle}
          />
        ...
        <p className='text-gray-700 xs:text-xl lg:text-2xl font-sans leading-normal pt-8 md:pt-6 lg:pt-8'>
            I'm a full-stack developer with a passion for experimenting with new frameworks and platforms, while striving to create tools that myself and others can enjoy. I have experience working in a variety of languages, though I'm particularly fond of <a className='text-white font-medium' href='https://github.com/tterb?utf8=%E2%9C%93&tab=repositories&q=&type=&language=python font-medium'>Python</a> and <a className='text-white font-medium' href='https://github.com/tterb?utf8=%E2%9C%93&tab=repositories&q=&type=&language=javascript'>Javascript</a>.
        </p>
      </Inner>
    </Content>
  </Divider>
