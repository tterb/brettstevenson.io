...
const About = ({ id, avatar, isMobile }) => (
  <Divider
    className='flex relative bg-base-300 h-full max-h-180 md:max-h-160 lg:max-h-240'
    clipPath='polygon(0 12%, 100% 0%, 100% 88%, 0 100%)'
  >
    <Content id={id}>
      <Inner className='sm:mt-24 md:mt-12 lg:mt-8'>
        ...
        <div className='flex flex-col md:flex-row items-center mt-0 md:pt-2 px-2'>
          <GatsbyImage
            ...
            style={avatarStyle}
          />
          <span className='text-white text-2xl font-medium leading-tighter pt-8 hidden md:block md:pt-0 md:pl-10 lg:pl-12 lg:text-3xl xl:text-4xl'>
        ...
        <p className='text-gray-700 text-xl lg:text-2xl font-sans leading-normal pt-8 md:pt-6 lg:pt-8'>
