...
<p className='badges flex mb-10'>
  <a className='pr-3' href='https://travis-ci.org/tterb/yt2mp3'><img src='https://travis-ci.org/tterb/yt2mp3.svg?branch=master' alt='Build Status'/></a>
  <a className='pr-3' href='https://pypi.python.org/pypi/yt2mp3/'><img src='https://img.shields.io/pypi/v/yt2mp3.svg' alt='PyPi Version'/></a>
  <a className='pr-3' href='https://codecov.io/gh/tterb/yt2mp3'><img src='https://codecov.io/gh/tterb/yt2mp3/branch/master/graph/badge.svg' alt='CodeCov'/></a>
  <a className='pr-3' href='https://yt2mp3.readthedocs.io/en/latest/?badge=latest'><img src='https://readthedocs.org/projects/yt2mp3/badge/?version=latest' alt='Documentation Status'/></a>
  <a className='pr-3' href='https://pypi.python.org/pypi/yt2mp3/'><img src='https://pypip.in/py_versions/yt2mp3/badge.svg' alt='PyPI Python Versions'/></a>
  <a className='pr-3' href='https://opensource.org/licenses/MIT'><img src='https://img.shields.io/badge/License-MIT-yellow.svg' alt='License'/></a>
</p>  
